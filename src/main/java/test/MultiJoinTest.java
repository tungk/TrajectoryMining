...
public class MultiJoinTest {
	...
	// BaselineLayout bl = new BaselineLayout(context.textFile(hdfs_input,
    ...
    private static PairFunction<Long, Long, Long> MAPTOPAIR = new PairFunction<Long, Long, Long>() {
    ...
    private static PairFunction<Tuple2<Long, Long>, Long, Long> STAGE_MAP = new PairFunction<Tuple2<Long, Long>, Long, Long>() {
    ...
    private static Function2<Long, Long, Long> STAGE_REDUCE = new Function2<Long, Long, Long>() {
