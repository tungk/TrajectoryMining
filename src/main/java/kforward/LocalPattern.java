 ...
 * 
 */
public class LocalPattern implements Function<Iterable<ArrayList<SimpleCluster>>, Iterable<HashSet<Integer>>>{
...
//	this.G = G;
    ...
    @Override
    public Iterable<HashSet<Integer>> call(Iterable<ArrayList<SimpleCluster>> v1)
	    throws Exception { 
	ArrayList<ArrayList<SimpleCluster>> tmp = new ArrayList<>();
	Iterator<ArrayList<SimpleCluster>> itr = v1.iterator();
...
class SimpleClusterListComparator implements Comparator<ArrayList<SimpleCluster>>, Serializable {
    private static final long serialVersionUID = -7921743971973093960L;
    @Override
    public int compare(ArrayList<SimpleCluster> o1, ArrayList<SimpleCluster> o2) {
